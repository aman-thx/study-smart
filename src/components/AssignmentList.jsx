...
export default function AssignmentList({ courseId, onUpdate }) {
  ...
  return (
    <div className="mt-4">
      {validationError && (
        <div className="mb-3 p-2 bg-red-100 text-red-700 text-sm rounded-lg border border-red-200">
          ⚠️ {validationError}
        </div>
      )}
